...
Matcher.prototype._matchAttributes = function(s, index) {
    ...
    return {
        ...
        endOffset: this._tagEndIndex(s, ATTRIB.lastIndex),
    };
};

var TAG_END = / ?\/?>/g;
Matcher.prototype._tagEndIndex = function(s, index) {
            ...
            if (stack.length > 0) {
                ...
                for (var i = stack.length - 1; i >= 0; i--) {
                    if (stack[i].nodeName === tagName) {
                        ...
                        var endOffset = this._tagEndIndex(s, this._matchRe.lastIndex);
